  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0">
      <div
        ...
        style={{
          background: `radial-gradient(circle, ${GREEN_ON_DARK}18 0%, transparent 72%)`,
        }}
      />
  ...
  return (
    ...
    >
      <div className="relative h-full min-h-[11rem] w-full sm:min-h-[13rem] lg:min-h-0">
        ...
        <div
          className="absolute inset-0 bg-gradient-to-r from-jet-black from-[22%] via-jet-black/88 via-[42%] to-transparent to-[68%] max-lg:from-[28%] max-lg:via-[48%] max-lg:to-[76%]"
        />
        <div
          className="absolute inset-0 bg-gradient-to-b from-jet-black via-jet-black/70 to-transparent to-[52%] lg:from-jet-black/55 lg:via-transparent lg:to-transparent"
        />
        <div
          className="absolute inset-0 bg-gradient-to-t from-jet-black via-transparent to-transparent to-[28%] max-lg:to-[22%]"
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(ellipse 72% 88% at 90% 44%, rgba(31,122,82,0.2), transparent 58%)",
          }}
        />
        <div
          className="pointer-events-none absolute inset-y-[10%] right-[6%] w-px bg-gradient-to-b from-transparent via-[#1f7a52]/30 to-transparent opacity-70"
        />
      </div>
    </SettleImage>
  );
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 z-[1] bg-gradient-to-b from-jet-black/30 via-transparent to-transparent lg:hidden"
        />
