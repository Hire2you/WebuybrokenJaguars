  ...
  return (
    <div className="flex items-center gap-4 border-b border-black/[0.08] py-5 last:border-b-0 lg:py-6">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1.5 text-sm leading-relaxed text-brand-slate">{body}</p>
      </div>
    </div>
  );
}
    ...
    <>
      ...
      <Section id="what-we-stand-for" background="offwhite">
        <div className="grid items-stretch gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14 xl:gap-16">
          <RevealFrom direction="left" className="min-w-0">
            <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-2xl bg-brand-green p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_30px_48px_-20px_rgba(10,61,42,0.85)] sm:p-10 lg:min-h-[28rem]">
              <span
                aria-hidden="true"
