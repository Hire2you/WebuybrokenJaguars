    ...
    >
      {!imageMissing ? (
        <>
          ...
          />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_95%_60%_at_50%_100%,rgba(31,122,82,0.08),transparent_68%)]" />
        </>
      ) : (
        <div className="relative h-full w-full">
          ...
          />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_95%_60%_at_50%_100%,rgba(31,122,82,0.06),transparent_68%)]" />
        </div>
      )}
    </div>
  );
