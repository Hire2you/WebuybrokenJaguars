...
function WhyUsImage() {
  ...
  return (
    <figure className="flex flex-col pt-20 pb-0 sm:pt-16 lg:min-h-0 lg:h-full lg:pt-0 lg:pb-0 max-lg:-mb-8">
      ...
      >
        <div className="pointer-events-none absolute inset-x-0 top-[12%] mx-auto h-32 w-32 rounded-full bg-brand-green/[0.05] blur-3xl sm:h-40 sm:w-40" />
      </div>
    ...
    <Section id="why-us">
      <div className="grid items-stretch gap-4 sm:gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,3fr)] lg:gap-12 xl:gap-16">
        ...
        <div className="min-w-0">
          ...
          <RevealGroup as="ul" className="mt-8 md:mt-10 xl:grid xl:grid-cols-2 xl:gap-x-10">
