...
function StepVisual({ step }: { step: Step }) {
  ...
  return (
    <PlaceholderImage
      ...
      className="w-full shadow-[0_22px_40px_-24px_rgba(10,61,42,0.35)]"
    />
  );
}
      ...
      {points.map((point) => (
        <li key={point} className="flex items-center gap-3.5">
          <IconSquare
            ...
            strokeWidth={2.5}
          />
          <span className="text-sm font-medium leading-snug text-brand-slate md:text-[0.9375rem]">
            {point}
          </span>
        </li>
      ))}
    ...
    <RevealFrom direction={direction} className={`min-w-0 ${className}`}>
      <div className="relative pr-16 sm:pr-20">
        <RevealGroup>
          ...
          <RevealItem>
            <p className="mt-3 max-w-prose text-base leading-relaxed text-brand-slate">
              {step.body}
            </p>
          </RevealItem>
          <RevealItem>
        ...
        >
          <span
            className="font-numeral text-[3.25rem] font-medium italic leading-none tracking-tight text-brand-green/25 sm:text-5xl"
            aria-hidden="true"
          >
            {step.number}
          </span>
...
function TimelineStep({
  ...
  return (
    <li className="relative list-none">
      <div
        aria-hidden="true"
        className="absolute top-10 left-4 z-20 h-3.5 w-3.5 -translate-x-1/2 rounded-full border-2 border-off-white bg-brand-green shadow-[0_0_0_4px_rgba(245,246,245,1)] lg:left-1/2"
      />
  ...
  return (
    <li className="flex items-center gap-4 border-b border-black/[0.08] py-4 last:border-b-0">
      {variant === "helpful" ? (
        ...
        <span
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-black/[0.05]"
        >
          <Minus
            size={ICON_SIZE}
            strokeWidth={ICON_STROKE}
            aria-hidden
            className="text-brand-slate/45"
          />
        </span>
      )}
...
function ComparisonList({
  ...
  return (
    <div
      className={
        isHighlight
          ? "rounded-2xl border border-brand-green bg-brand-green p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_30px_48px_-20px_rgba(10,61,42,0.85)] sm:p-8 lg:-translate-y-1 lg:scale-[1.02]"
    ...
    <>
      ...
      >
        ...
        <div className="relative mt-12 lg:mt-16">
          <div
            aria-hidden="true"
            className="absolute top-0 bottom-0 left-4 w-px bg-brand-green/35 lg:left-1/2 lg:-translate-x-1/2"
          />
      ...
      <Section id="what-you-need" background="white">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14 xl:gap-16">
          <RevealFrom direction="left" className="min-w-0">
            <SettleImage
              className="relative aspect-[16/10] overflow-hidden rounded-xl shadow-[0_22px_40px_-24px_rgba(10,10,10,0.18)] ring-1 ring-brand-green/10"
            >
              <Image
          ...
          <RevealFrom direction="right" className="min-w-0">
            <div>
              <h3 className="text-xs font-semibold uppercase tracking-[0.22em] text-brand-green">
                WHAT YOU NEED
              </h3>
        ...
        <RevealGroup className="mt-10 lg:mt-12">
          <RevealItem>
            <p className="max-w-2xl text-sm leading-relaxed text-brand-slate md:text-base">
      ...
      >
        <div aria-hidden="true" className="pointer-events-none absolute inset-0">
          <div
            ...
            style={{
              background: `radial-gradient(circle, ${GREEN_ON_DARK}18 0%, transparent 68%)`,
            }}
          />
        </div>
        ...
        >
          <div
            ...
            style={{
              ...
              background:
                "linear-gradient(90deg, #1a6b4a 0%, #1f7a52 5%, rgba(31,122,82,0.45) 38%, rgba(31,122,82,0.12) 62%, transparent 100%)",
            }}
          />
          <div
