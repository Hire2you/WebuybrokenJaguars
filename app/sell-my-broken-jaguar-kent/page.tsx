  ...
  if (town.published) {
    return (
      <Link
        ...
        className="flex items-center gap-3.5 border-b border-black/[0.08] py-4 transition-colors hover:text-brand-green"
      >
        {content}
      </Link>
    );
  ...
  return (
    <>
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14 xl:gap-16">
          ...
          <RevealFrom direction="right" className="min-w-0">
            <RevealGroup>
              ...
              <RevealItem>
                <p className="mt-4 max-w-prose text-base leading-relaxed text-brand-slate md:text-lg">
      ...
      <Section id="kent-paperwork" background="offwhite">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14 xl:gap-16">
          <RevealFrom direction="left" className="min-w-0">
            <SettleImage className="relative aspect-[16/10] overflow-hidden rounded-xl shadow-[0_22px_40px_-24px_rgba(10,10,10,0.18)] ring-1 ring-brand-green/10">
              <Image
      ...
      >
        <div aria-hidden="true" className="pointer-events-none absolute inset-0">
          <div
            ...
            style={{
              background: `radial-gradient(circle, ${GREEN_ON_DARK}20 0%, transparent 68%)`,
            }}
          />
        </div>
        ...
        <div className="relative z-10 grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)] lg:gap-14 xl:gap-16">
          <RevealFrom direction="left" className="min-w-0">
            <figure className="relative mx-auto flex w-full max-w-[280px] items-center justify-center sm:max-w-[320px] lg:mx-0 lg:max-w-none">
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-[8%] rounded-full bg-brand-green/[0.12] blur-3xl"
              />
              <div className="relative aspect-square w-full overflow-hidden rounded-full border-2 border-white/80 shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_22px_40px_-24px_rgba(10,61,42,0.8)] ring-2 ring-white/35 ring-offset-2 ring-offset-jet-black">
        ...
        <RevealGroup className="mt-12 grid gap-6 md:grid-cols-3">
          {OTHER_OPTIONS.map((option) => (
            <RevealItem key={option.title}>
              <article className="h-full rounded-2xl border border-line bg-white p-6 shadow-[0_10px_30px_-20px_rgba(10,10,10,0.28)] sm:p-8">
                <h3 className="text-lg font-bold tracking-tight text-ink">
                  {option.title}
                </h3>
                <p className="mt-4 text-sm leading-relaxed text-brand-slate md:text-[0.9375rem]">
                  {option.body}
                </p>
              </article>
            </RevealItem>
