...
function OfferPanelBackdrop() {
  return <GreenPanelBackdrop className="rounded-[10px]" />;
}
...
export default function OfferCountPanel() {
  ...
  return (
    <Reveal
      className="relative aspect-[16/10] w-full max-w-full overflow-hidden rounded-xl border-2 border-brand-green-dark shadow-[inset_0_1px_0_rgba(255,255,255,0.22),0_22px_40px_-24px_rgba(10,61,42,0.8)] ring-2 ring-brand-green-dark/80 ring-offset-2 ring-offset-off-white"
    >
      <OfferPanelBackdrop />
