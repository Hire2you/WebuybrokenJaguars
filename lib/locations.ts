...
export const COUNTIES: LocationCounty[] = [
  ...
  {
    name: "East Sussex",
    slug: "sell-my-broken-jaguar-east-sussex",
    title: "Sell My Broken Jaguar in East Sussex",
    description:
      "Broken, damaged and non-running Jaguars bought across East Sussex by Jaguar specialists, not a scrap yard. Free collection on our own recovery from Brighton to the Weald, same-day payment.",
    areaServed: [
      "East Sussex",
      "Brighton and Hove",
      "Hastings",
